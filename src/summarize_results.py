...
# Adjust to your repo: this script assumes you run it from src/
output_dir = Path("outputs")
output_dir.mkdir(parents=True, exist_ok=True)

# Helper: pick the most recent file matching a pattern
...
# Safe extractor for possibly nested/varied refutation formats
def format_refutation_value(val):
    """
    Accepts dict, list, or str. Returns a readable string.
    """
    if val is None:
        return "N/A"
    if isinstance(val, dict):
        # pretty-print important keys if present
        parts = []
...
# Build summary text
lines = []
lines.append("# 🧠 Causal Analysis Summary")
lines.append(f"Generated: {datetime.now().isoformat()}\n")

# ATE section
if ate_df is not None and not ate_df.empty:
    lines.append("## 📊 Average Treatment Effect (ATE) Summary\n")
...
# Footer
lines.append("---")
lines.append("✅ Summary generated by summarize_results.py")

# Save markdown and plain text
